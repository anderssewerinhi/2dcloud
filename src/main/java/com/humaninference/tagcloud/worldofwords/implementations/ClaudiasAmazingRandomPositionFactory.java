 ...
 * 
 */
public class ClaudiasAmazingRandomPositionFactory implements PositionFactory {
	private final Random rnd;

	public ClaudiasAmazingRandomPositionFactory(final long seed) {
	...
	public static final void main(final String... strings) {
		final ClaudiasAmazingRandomPositionFactory rf = new ClaudiasAmazingRandomPositionFactory(42);
		for ( int i = 0; i < 10; ++i) {
